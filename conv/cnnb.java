...
public class cnnb
{
    public static void main(String[] args) {       
        ...
        networkCost(input, label, biases1, kernel1, biases2, kernel2, true);
        System.out.println("*********************************************************************");
        
        double[] gradBiases1 = clone(biases1);
        for(int i=0; i<gradBiases1.length; i++) {
            biases1[i] += epsilon;
            double newCost1 = networkCost(input, label, biases1, kernel1, biases2, kernel2, false);
            biases1[i] -= epsilon;
            
            biases1[i] -= epsilon;
            double newCost2 = networkCost(input, label, biases1, kernel1, biases2, kernel2, false);
            biases1[i] += epsilon;
    ...
    public static double networkCost(double[][][][] input, double[][][][] label, double[] biases1, double[][][][] kernel1, double[] biases2, double[][][][] kernel2, boolean print) {       
        ...
        if(print) {
            ...
            double[][][][] gB1 = hadMul(trans_pool(trans_conv(gB2,kernel2,p1_3,p2_3,s1_3,s2_3,0,0),switches1,sig_output1),dsigmoid(output1,biases1));
            System.out.println("*********************************************************************");
            print(col(gB1));
