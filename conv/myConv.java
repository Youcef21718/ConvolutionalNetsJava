...
public class myConv
{
    public static void main(String[] args) {
        ...
        double[] output = conv(input, kernel, p, s);
        
        double[][] mat = convMat(input, kernel, p, s);       
        double[][] mat_trans = convMat(dil(output,s,a), rot(kernel), k-p-1, 1);
        
        print(output);
        print(mul(mat, input, false));
        
        print(mul(mat_trans, dil(output,s,a), false));
