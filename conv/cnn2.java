...
public class cnn2 
{
    public static void main(String[] args) {       
        ...
        networkCost(input, label, biases1, kernel1, biases2, weights2, true);
        ...
        for(int i=0; i<gradBiases1.length; i++) {
            biases1[i] += epsilon;
            double newCost1 = networkCost(input, label, biases1, kernel1, biases2, weights2, false);
            biases1[i] -= epsilon;
            
            biases1[i] -= epsilon;
            double newCost2 = networkCost(input, label, biases1, kernel1, biases2, weights2, false);
            biases1[i] += epsilon;
    ...
    public static double networkCost(double[][][][] input, double[][] label, double[] biases1, double[][][][] kernel1, double[] biases2, double[][] weights2, boolean print) {       
        int p1_1=1, p2_1=1;
        int s1_1=2, s2_1=2;
        ...
        //double[][] output3 = mul(batch(output2),weights3);
